...
public interface NameHelper {
	 ...
	 * <p>if optional {@link ClassLoader}s are not specified, then both {@link org.Vrglab.Reflections.util.ClasspathHelper#contextClassLoader()} and {@link org.Vrglab.Reflections.util.ClasspathHelper#staticClassLoader()} are used
	 * */
